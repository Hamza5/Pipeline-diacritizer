        ...
        for i in range(1, epochs + 1):
            ...
            for k in range(len(self.train_targets)):
                l, a, p, r = self.model.train_on_batch(
                    ...
                    self.train_targets[k], class_weight=self.balancing_factors
                )
...
if __name__ == '__main__':
    ...
    gemination_model = GeminationModel([128, 64], [0.1, 0.1])
    gemination_model.feed_data(train_sentences, test_sentences)
    gemination_model.train(1)
    gemination_model.visualize(20)
